...
class AuthApiTest {
    ...
    @Autowired
    private com.crowdflow.repository.UserRepository users;
    ...
    private static String uniqueEmail(String prefix) {
        return prefix + "-" + UUID.randomUUID() + "@crowdflow.local";
    }
    ...
    void theSameEmailCannotRegisterTwice() throws Exception {
        String email = "dupe-" + UUID.randomUUID() + "@crowdflow.local";
    ...
    void aWrongPasswordIsRejected() throws Exception {
        String email = "wrong-" + UUID.randomUUID() + "@crowdflow.local";
